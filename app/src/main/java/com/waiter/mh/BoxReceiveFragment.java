 ...
 * 盒子送达网点
 */
public class BoxReceiveFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_box_receive, container, false);
    }
    ...
    private void submitData() {
        ...
        HttpUtil.getInstance().receiveBox(submitData, new HttpUtil.SuccessCallback() {
            @Override
